                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-[40px] md:gap-[87px] pb-[25px] sm:pb-[150px] items-stretch'>
                    ...
                    {/* <div className='relative w-full h-[430px]'>
                        ...
                        <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
                            <button className="video-launch video-play-button cursor-pointer" rel="shadowbox;height=450;width=800" href="https://www.facebook.com/kazifoodmuksudpur/videos/1265450145367450">
                                <span></span>
                            </button>
                        </div>
                    </div> */}
                    ...
                    <div className='relative w-full h-[430px]'>
                        ...
                        <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
                            <button
                                onClick={() => window.open("https://www.facebook.com/kazifoodmuksudpur/videos/1265450145367450", "_blank")}
                                className="video-launch video-play-button cursor-pointer"
                            >
                                <span></span>
                            </button>
                        </div>
